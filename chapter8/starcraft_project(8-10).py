...
class Tank(AttackUnit):
    # 시즈모드 : 탱크를 지상에 고정, 더 높은 공격 가능, 이동불가
    ...
    def set_seize_mode(self):
        if Tank.seize_developed == False:
            return  # 시즈모드가 개발 되지 않았을 경우 아무것도 안하고 나감
...
for unit in attack_units:
    # isinstance() : 지금 만들어진 객체가 어떤 클래스의 인스턴스인지 확인하는 것
